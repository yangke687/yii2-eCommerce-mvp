...
class Product extends \yii\db\ActiveRecord
{
    ...
    {
        if ($this->imageFile) {
            $pathname = Yii::getAlias('@frontend/web/storage/products/');
            $folderName = date('Y-m-d');
            $filename = $folderName . '/' . $this->imageFile->name;

            $this->image = '/products/' . $filename;
        }
        ...
        if ($ok) {
            if (isset($pathname) && isset($filename)) {
